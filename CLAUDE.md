...
This project is indexed by GitNexus as **goldfish** (1171 symbols, 1401 relationships, 30 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
